...
//     {
//         title: 'Coffee Mugs',
//         image: 'https://images.unsplash.com/photo-1698280954292-c955f882486f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaW5uZXIlMjB0YWJsZSUyMHNldHRpbmd8ZW58MXx8fHwxNzYwMzQ3NDIyfDA&ixlib=rb-4.1.0&q=80&w=1080',
...
//                 {/* Section Title */}
//                 <h2
//                     className="mb-8 text-3xl text-[#172554]"
//                     style={{
...
//                 {/* Cards Grid - Single row on large screens */}
...
export default function ShopByOccasion() {
  return (
    <section id="occasion" className="py-12 lg:py-16">
      <div className="w-full px-4 lg:px-8">
        {/* Section Title - Left Aligned with Short Pink Underline */}
        <div className="relative mb-12 inline-block">
          ...
          {/* Pink Underline - Same Width as Heading */}
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 lg:gap-6">
          {occasions.map((occasion, index) => (
            <div
              key={index}
              className="group relative overflow-hidden aspect-[3/4] rounded-md cursor-default"
            >
              <div className="relative w-full h-full">
                <Image
                  src={occasion.image}
