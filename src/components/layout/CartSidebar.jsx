...
export default function CartSidebar({ isOpen, onClose }) {
  ...
  // AUTO-CLOSE SIRF JAB justRemoved TRUE HO
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`fixed right-0 top-0 h-full w-full max-w-md bg-white rounded-l-2xl shadow-2xl z-50 transition-transform duration-300 ease-in-out flex flex-col ${
