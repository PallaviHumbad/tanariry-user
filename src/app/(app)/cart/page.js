...
export default function CartPage() {
  ...
  if (!mounted) return <div className="min-h-screen bg-gray-50 py-12"><div className="max-w-7xl mx-auto px-4">Loading...</div></div>;
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-24">
            ...
            <h2 className="text-3xl font-bold text-[#172554] mb-2">Your cart is empty</h2>
            <p className="text-gray-600 mb-8">Add some premium crockery to get started!</p>
            <Link
              href="/products"
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 lg:py-12">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-4xl md:text-5xl font-playfair text-[#172554] font-normal">Your Cart</h1>
        ...
        <div className="grid lg:grid-cols-3 gap-8 pb-4">
            ...
            {cart.map((item) => {
              ...
              return (
                <div
                  ...
                  className="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 p-5 border border-gray-100"
                >
                  <div className="flex gap-5">
                    {/* Image */}
                    <div className="w-28 h-28 rounded-xl overflow-hidden flex-shrink-0 border border-gray-200">
                      <Image
                        src={safeImage}
                        alt={safeName}
                        width={112}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-6">
              <h2 className="text-xl font-semibold text-[#172554] mb-4">Price Details</h2>
